...
- **Essence:** This is not a data _embedding_ method, but a _matching_ method. It allows embedding a message **without changing** some bits of the carrier.
...
_Note: An impulse burst is periodically repeating impulses over a fixed time interval._
